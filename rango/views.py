...
def index(request):
    ...
    # Return response back to the user, updatin any cookies that need changed.
    return response
...
def register(request):
    ...
    if request.method == 'POST':
        # Attempt to rab informatino from the raw form information.
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            # untril we're ready to avoid integrity problems.
